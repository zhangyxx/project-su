    ...
    <div>
        ...
        <main>
            <div class="jin">
                ...
                <p></p>
                <p></p>
                <p>查看全部<img src="../assets/images/箭头右2.png"></p>
            </div>
            <div class="tan">
                <div class="tan-item"><img src="../assets/images/审核中.png">审核中</div>
